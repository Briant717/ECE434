...
int main(int argc, char *argv[]) {
    ...
    printf("Start copying GPIO_2 to GPIO_3\n");
    printf("Start copying GPIO_15 to GPIO_16\n");

    while(keepgoing) {
    	if(*gpio_datain & GPIO_922) {
            *gpio_setdataout_addr= GPIO_921;
    	} else {
            *gpio_cleardataout_addr = GPIO_921;
    	}

	if(*gpio_datain & GPIO_924) {
	    *gpio_setdataout_addr1= GPIO_915;
	} else {
	    *gpio_cleardataout_addr1 = GPIO_915;
	}
        usleep(1);
    }
